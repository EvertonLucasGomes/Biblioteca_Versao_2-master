            ...
            <?php
                ...
                if($aluguel != null){
                    print('
                        ...
                        <form action="gerenteApagarEmprestimo.php" method="POST">
                            <span>Excluir Emprestimo</span>
                            <input type="text" name="id" value='.$aluguel->getId().' readonly>
                            <input type="submit" value="EXCLUIR" id="botao">
                        </form>
                        ');
                }
                else{
                    print('<div class="alerta atencao">Emprestimo não encontrado.</div>');
                }
            ?>
