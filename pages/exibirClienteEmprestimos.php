...
<head>
    ...
    <title>Consulta de Emprestimos por Cliente</title>
</head>
    <header>
        <nav>
            <ul id="menu">
    ...
    <main>
        <strong>Consulta de Emprestimos por Cliente</strong>
        <div id="content_main">
            <?php
                require_once('../scripts/persistencia/persistencia.php');

                $alugueis = persistencia::getInstance()->getEmprestimoCliente($_POST['cpfCliente']);
